 ...
 * **`modelling`**: Includes the modelling generated data used to produce the Supp. Figure 4 (changes in the fractionation factor od DddP with different assumptions of enzyme degradation rate, $V_{max}$ and $V_{max}/K_M$) and the Figure 4 (variations in the $\delta^{34}S of seawater DMSP affected by demethylation, bacterial cleavage and eukaryotic cleavage) of the paper.
