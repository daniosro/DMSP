...
# %%
# load data from the Supplementary Table 8 of Curson et al. (2018)
# load data
df_stab8_cursonetal_2018 = pd.read_csv(f'{homedir}/data/raw/genetics/stab8_cursonetal_2018.csv')
df_stab8_cursonetal_2018.head()
# %%
#Add a column of total transcripts per million sequences (TTPMS)
...
df_glength
# %%
#Filter the transcripts dataframe to include only the enzymes of interest
...
# %%
#Calculate reads per kilo base per million mapped reads
