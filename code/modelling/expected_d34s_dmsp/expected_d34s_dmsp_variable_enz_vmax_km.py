...
# Here, we will do so by assuming that the DMSP degrading enzymes have a variable number of Vmax/K_M.
...
# %%
# Now, we'll perform the numerical integration with ODEint
