...
def dmsp_enz_deg(
    ...
    should have to exhibit the pattern of d34S DMSP vs. time, 
    in nM/min/nM enzyme
    Vmax_d: float.
    km: float.
...
for i in kappa_32:
    ...
    #Append the fractionation factors for different Vmax to the 
...
df_34e_variable_32ratio.to_csv(
    f'{homedir}/data/modelling/34e_variable_32ratio.csv')