...
# Filter data by experiment B (started with 5 replicates with 100 uM DMSP 
# and 0.25X Alma1, where further Alma1 was added after 38 min of the start of the exp.)
...
# %%
#Export to csv
df_fit_paramls_add_b.to_csv(f'{homedir}/data/processed/enz_deg/addexp_mmfit_before_alma1_add.csv')
# %%
#Now, we will calculate the maximum velocity after the addition of further Alma1. 
...
# %%
#Export to csv
df_fit_paramls_add_b2.to_csv(f'{homedir}/data/processed/enz_deg/addexp_mmfit_after_alma1_add.csv')
# %%
